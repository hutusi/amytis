 ...
 * `w-1 h-1 rounded-full bg-surface-raised` separator. Always `aria-hidden` —
...
export default function MetaDot({ className }: MetaDotProps) {
  return <span aria-hidden="true" className={cn('w-1 h-1 rounded-full bg-surface-raised', className)} />;
}
