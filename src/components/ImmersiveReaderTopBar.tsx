...
export default function ImmersiveReaderTopBar({
  ...
  return (
    <header
      ...
      className="relative z-30 h-12 flex items-center gap-3 px-3 border-b border-line bg-background/95 backdrop-blur-md shrink-0 select-none"
    >
      <button
        type="button"
        ...
        className="h-8 w-8 inline-flex items-center justify-center rounded-md text-foreground/80 hover:text-accent hover:bg-surface-soft transition-colors"
      >
        ...
        <button
          ...
          className={`h-8 w-9 inline-flex items-center justify-center rounded-md transition-colors ${
            prefsPanelOpen
              ...
              : 'text-foreground/80 hover:text-accent hover:bg-surface-soft'
          }`}
        >
      ...
      <button
        ...
        className="h-8 w-8 inline-flex items-center justify-center rounded-md text-foreground/80 hover:text-accent hover:bg-surface-soft transition-colors shrink-0"
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
