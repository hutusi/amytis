export const translations = {
  en: {
    ...
    graph: "Graph",
    flow_view_mode: "View mode",
    flow_view_daily: "Daily",
    flow_view_stream: "Stream",
    flow_stream_description: "Daily notes in one continuous stream.",
    backlinks: "Backlinks",
  ...
  zh: {
    ...
    flow_view_daily: "日历",
    flow_view_stream: "流式",
    flow_stream_description: "随笔时间流，连续阅读每日所思。",
    backlinks: "反向链接",
