...
export const PROSE_CLASSES = `prose prose-lg max-w-none min-w-0 overflow-x-hidden text-foreground
      ...
      prose-code:bg-surface-soft prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md prose-code:border prose-code:border-line-strong prose-code:text-[0.9em] prose-code:font-medium
