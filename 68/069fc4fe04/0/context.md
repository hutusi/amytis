...
Do we need to refactor the code to make the style consistent?
...
do we need add some tests before refactor?
...
what do we need to refactor next?
...
what else to refactor next?

### Prompt 11

is @src/lib/markdown.ts is too long? what's your opinin?

### Prompt 12

do we need add some test? include integration tests and e2e tests.
